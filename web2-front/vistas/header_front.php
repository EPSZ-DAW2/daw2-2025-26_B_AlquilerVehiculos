  ...
  <div class="container topbar-inner">
    ...
    <div class="iconbar">
      ...
      <a class="iconbtn" href="<?= htmlspecialchars($BASE_URL) ?>/front/contrato.php">
        <img src="<?= htmlspecialchars($BASE_URL) ?>/recursos/img/icon-cesta.svg" alt="Cesta">
        <span>Mi cesta</span>
      ...
      <?php if ($isLogged): ?>
        <a class="iconbtn" href="<?= htmlspecialchars($BASE_URL) ?>/front/mis_reservas.php">
          <img src="<?= htmlspecialchars($BASE_URL) ?>/recursos/img/icon-pedido.svg" alt="Pedido">
          <span>Pedido</span>
        </a>

        <a class="iconbtn" href="<?= htmlspecialchars($BASE_URL) ?>/front/perfil.php">
          <img src="<?= htmlspecialchars($BASE_URL) ?>/recursos/img/icon-user.svg" alt="Cuenta">
          <span>Mi cuenta</span>
        </a>
      ...
      <?php else: ?>
        <a class="iconbtn" href="<?= htmlspecialchars($BASE_URL) ?>/front/login.php">
          <img src="<?= htmlspecialchars($BASE_URL) ?>/recursos/img/icon-user.svg" alt="Login">
