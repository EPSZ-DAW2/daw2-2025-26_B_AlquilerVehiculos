...
/*
  ...
  ================================
  if(!isset($_SESSION['usuario'])) { header("Location: /front/login.php"); exit; }
  if($_SESSION['usuario']['rol'] !== 'admin') { header("Location: /index.php"); exit; }
*/
...
// Header admin (incluye BASE_URL + CSS)
